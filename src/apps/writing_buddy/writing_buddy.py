...
class WritingBuddy(AbstractBuddy):
    ...
    def generate_response(self):
        # Load content
        system_content = read_markdown("apps/writing_buddy/v1/prompts/system.md")
        user_content = read_markdown("apps/writing_buddy/v1/prompts/user.md")
        ...
        output_file = write_markdown(file_path="apps/writing_buddy/response.md", write_content=response)
